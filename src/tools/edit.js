...
class EditTool extends Tool {
  ...
  async handler(args, tool) {
    ...
    tool.message({ state: 'spin', subject: `${file_path} (${ANSI.fg('-' + linesNeg, EditTool.REM_COLOR)} ${ANSI.fg('+' + linesPos, EditTool.ADD_COLOR)})` });
    ...
    tool.message({ state: 'done', subject: `${file_path} (${ANSI.fg('-' + linesNeg, EditTool.REM_COLOR)} ${ANSI.fg('+' + linesPos, EditTool.ADD_COLOR)})` });
    return result;
  }
