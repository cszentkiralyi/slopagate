...
- Qwen especially *loves* reading whole files instead of using `grep` to narrow down ranges. What if we block whole-file `read` until the agent searches or the user mentions the file by name?
