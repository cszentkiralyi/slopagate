...
> Based on src/slopagate.sh and README.md, create a PROJECT.md file that summarizes the project's purpose and structure for another coding agent to read later.
